...
public class BotFrame implements FrameInterface {
	...
	String personName;
		...
		public Tile getTileRank(int rank) throws RankOutOfBoundsException {
					...
					if((rank<0)||(rank>=numOfElementsInFrame)){
 ...
 */
	...
	public String displayFrame() throws NullPointerException{ 
		...
		public Tile removeFromFrame(char c) {
		...
		public void placeBackIntoFrame(Tile e, int rank){
			//System.out.println("pbife: " +e.tname);
			numberOfElements++;
			arrayOfTiles[rank] = e;
			//System.out.println("pbifaot: " +arrayOfTiles[rank]);
		}
}
