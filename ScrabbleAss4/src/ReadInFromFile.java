...
public class ReadInFromFile {
    ...
    public void copyFile(String sourceFileName, String sourceNumFile)  throws FileNotFoundException
    	{
						String Path1 = new File("src/abc.txt").getAbsolutePath();
						String Path2 = new File("src/123.txt").getAbsolutePath();
						File lettersURL = new File(Path1);
						File numbersURL = new File(Path2);
