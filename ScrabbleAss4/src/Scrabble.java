...
// CHALLENGE															
															...
															if(flag){
																...
																System.out.println("Word is not in scrabble dictionary, " + p.playerid + " you have lost a turn");
																	p.playerScore = p.getScore() - scoreDifference;
																		...
																		for(int i=0;i<7;i++){
																			newPool.insertAtRandom(playerOneFrame.getTileRank(i));
																			//System.out.println("PS: " +newPool.size());
																			//System.out.println("FS: " + playerOneFrame.frameSize());
																		}
																		//noRefill = true;
																			ui.controlGameFlow++;
															}
									...
									if(!noRefill){
										...
										for(int k =0;k<7;k++){
											...
											if(playerOneFrame.getTileRank(i).equals(null)){
