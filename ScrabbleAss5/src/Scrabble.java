		...
		do {
			...
			do {
				if (currentPlayerId == BOT_ID) {
					...
					commandCode = newbot.getCommand(currentPlayer,board,dictionary);
					ui.displayCommand(players[BOT_ID],commandCode,newbot.getWord(), newbot.getLetters());
				}
				else {
